...
/*
敗因　右下方向の斜めしか考慮に入れてなかった＆＆右端の方だと右下斜めの条件を満たさなくなることを考慮していなかった
よって失敗
...
`
	...
	for n:=0;n+128<801;n=n+2{
		v1,_ := strconv.Atoi(num[n:n+2])
		v2,_ := strconv.Atoi(num[n+42:n+44])
		v3,_ := strconv.Atoi(num[n+84:n+86])
		v4,_ := strconv.Atoi(num[n+126:n+128])
		product = v1*v2*v3*v4
		if ans < product {
			ans = product
